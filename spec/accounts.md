...
- Signed-in users can sign out and return to Shelf's home page after the identity provider ends its session. New users have no board until they create one in `/admin`.

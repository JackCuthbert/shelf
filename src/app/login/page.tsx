...
export default async function LoginPage() {
  ...
  return (
    <main className="relative flex flex-1 flex-col px-6">
      <AnonymousPageNav showSignIn={false} />
      <div className="mx-auto flex w-full flex-1 max-w-md flex-col justify-center">
